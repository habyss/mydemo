...
public class ConstantMsg {
    ...
    public static final String SUCCESS_UPLOAD = "发送成功";
    public static final String FAILURE_UPLOAD = "发送失败";
